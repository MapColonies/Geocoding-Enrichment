...
import { PROCESS_ROUTER_SYMBOL } from './process/routes/processRouter';
...
export class ServerBuilder {
  ...
  public constructor(
    ...
    @inject(PROCESS_ROUTER_SYMBOL) private readonly processRouter: Router,
  ) {
  ...
  private buildRoutes(): void {
    this.serverInstance.use('/process', this.processRouter);
